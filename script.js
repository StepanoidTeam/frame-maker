...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function applyPreset(id) {
        ...
        document.querySelectorAll('.color-swatch[data-type="frame"]').forEach(s => {
            if (s.dataset.color === state.frameColor) s.classList.add('active');
            else s.classList.remove('active');
        });
         document.querySelectorAll('.color-swatch[data-type="text"]').forEach(s => {
    ...
    function updateSVG() {
        ...
        if (pathEl) {
            ...
            if (preset && preset.frameStyle === 'gradient' && state.frameColor === preset.frameColor) {
    ...
    document.querySelectorAll('.color-swatch[data-type="text"]').forEach(swatch => {
        swatch.addEventListener('click', (e) => {
            state.textColor = e.target.dataset.color;
            // Update active state UI
            document.querySelectorAll('.color-swatch[data-type="text"]').forEach(s => s.classList.remove('active'));
    ...
    document.querySelectorAll('.color-swatch[data-type="frame"]').forEach(swatch => {
        swatch.addEventListener('click', (e) => {
            state.frameColor = e.target.dataset.color;
            // Update active state UI
            document.querySelectorAll('.color-swatch[data-type="frame"]').forEach(s => s.classList.remove('active'));
            e.target.classList.add('active');
